...
class DownloadResponse extends Base implements ResponseInterface
{
	private $filename;
	private $file;
	private $setMime;
	...
	public function setBinary(string $binary)
	{
		if ($this->file !== null)
		{
			throw new \RuntimeException("When setting filepath can not set binary.");
		}
	...
	public function setFilePath(string $filepath)
	{
		if ($this->binary !== null)
		{
			throw new \RuntimeException("When setting binary can not set filepath: {{$filepath}}");
		}
	...
	{
		throw new \RuntimeException("It does not supported change status code for downloading. code: {{$code}}, reason: {{$reason}}");
	}
	...
	{
		throw new \RuntimeException("It does not supported caching for downloading.");
	}
	...
	public function sendBody()
	{
		...
		throw new \RuntimeException("Not found download body source.");
	}
